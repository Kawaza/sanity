                    ...
                    <div className="container mx-auto pb-0 px-10 md:px-24">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-0 md:gap-40">
                            <div className=" pt-20 gap-20">
                                <div>
                                    <h3 className="text-3xl md:text-4xl mb-2 text-white text-left pb-6">Description</h3>
                                    <p className="text-lg leading-7">{project.projectDescription}</p>
                                </div>
                            </div>
                            <div className=" pt-20 gap-20">
                                <div>
                                    <h3 className="text-3xl md:text-4xl mb-2 text-white text-left pb-6">Technology</h3>
